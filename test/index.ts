...
class A {
  constructor (public readonly a: number, public readonly name: string) { /* empty */ }
}
class B {
  constructor (public readonly b: number, public readonly name: string) { /* empty */ }
}
class C {
  constructor (public readonly c: number, public readonly name: string) { /* empty */ }
}
type Foo = A | B | C;
